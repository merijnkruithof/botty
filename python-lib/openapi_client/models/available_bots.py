...
class AvailableBots(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.bots:
            ...
            _dict['bots'] = _items
        # set to None if bots (nullable) is None
        # and model_fields_set contains the field
        if self.bots is None and "bots" in self.model_fields_set:
            _dict['bots'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bots": [BotInfo.from_dict(_item) for _item in obj["bots"]] if obj.get("bots") is not None else None
        })
        return _obj
